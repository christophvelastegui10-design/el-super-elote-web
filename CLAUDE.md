...
@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;1,300&family=DM+Sans:wght@400;500&display=swap');
...
3. Features      — 3-6 características clave con iconos/ilustraciones
...
3. Sobre mi      — Historia, habilidades, valores
...
2. Servicios     — Cards con iconos descriptivos
...
<section class="hero" aria-labelledby="hero-heading">
  <div class="hero__content">
    ...
    <p class="hero__subtitle">
      Subtitulo que complementa sin repetir. Máximo 2 líneas.
    </p>
...
<head>
  ...
  <meta name="description" content="Descripción clara, 120-160 caracteres, con keywords naturales.">
